...
namespace nmc
{
    ...
    void SnowEntity::draw(BITMAP *dest, int scrollx, int scrolly, unsigned int layer)
    {
    ...
    void SnowEntity::logic(Room *room)
    {
        mFrameCounter++;
    ...
    bool SnowEntity::drawInLayer(unsigned int layer)
    {
